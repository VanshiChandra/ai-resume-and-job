...
def register_user(name: str, email: str, password: str, role: str = "user"):
    """
    Register a new user with Supabase Auth and store their profile using service role.
    """
    try:
        ...
        # Insert profile record using service role (bypasses RLS)
...
def get_current_user(user_id: str):
    """
    Fetch full profile by user_id using service role.
    """
    try:
